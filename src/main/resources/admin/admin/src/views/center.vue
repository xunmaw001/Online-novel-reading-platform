<template>
  <div :style='{"padding":"30px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20220805/1b9b1a67bdd14d29bbcca744990004d8.png)","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 110px)"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='huiyuan'"  label="会员账号" prop="huiyuanzhanghao">
          <el-input v-model="ruleForm.huiyuanzhanghao" readonly              placeholder="会员账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='huiyuan'"  label="会员姓名" prop="huiyuanxingming">
          <el-input v-model="ruleForm.huiyuanxingming"               placeholder="会员姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='huiyuan'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='huiyuan'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='huiyuan'"  label="电话号码" prop="dianhuahaoma">
...
export default {
  ...
  mounted() {
    ...
    this.huiyuanvipOptions = "是,否".split(',')
  },
  methods: {
