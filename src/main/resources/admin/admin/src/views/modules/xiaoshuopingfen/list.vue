		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('xiaoshuopingfen','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('xiaoshuopingfen','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"99px","fontSize":"14px","height":"32px"}' v-if=" isAuth('xiaoshuopingfen','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"99px","fontSize":"14px","height":"32px"}' v-if=" isAuth('xiaoshuopingfen','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"99px","fontSize":"14px","height":"32px"}' v-if="isAuth('xiaoshuopingfen','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
