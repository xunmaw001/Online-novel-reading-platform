<template>
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20220805/1b9b1a67bdd14d29bbcca744990004d8.png)","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 110px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="评分编号" prop="pingfenbianhao">
					<el-input v-model="ruleForm.pingfenbianhao" placeholder="评分编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.pingfenbianhao" label="评分编号" prop="pingfenbianhao">
					<el-input v-model="ruleForm.pingfenbianhao" placeholder="评分编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="小说分类" prop="xiaoshuofenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="评分" prop="pingfen">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="评分" prop="pingfen">
					<el-input v-model="ruleForm.pingfen"
						placeholder="评分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="评分时间" prop="pingfenshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.pingfenshijian" label="评分时间" prop="pingfenshijian">
					<el-input v-model="ruleForm.pingfenshijian" placeholder="评分时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="会员账号" prop="huiyuanzhanghao">
					<el-input v-model="ruleForm.huiyuanzhanghao" placeholder="会员账号" clearable  :readonly="ro.huiyuanzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="会员账号" prop="huiyuanzhanghao">
					<el-input v-model="ruleForm.huiyuanzhanghao" placeholder="会员账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="会员姓名" prop="huiyuanxingming">
					<el-input v-model="ruleForm.huiyuanxingming" placeholder="会员姓名" clearable  :readonly="ro.huiyuanxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="会员姓名" prop="huiyuanxingming">
