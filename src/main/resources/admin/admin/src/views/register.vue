	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","backgroundAttachment":"fixed","alignItems":"flex-end","background":"url(http://codegen.caihongy.cn/20220805/fcc82c8be5f04b31a9d3c486f4ae68d4.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-start"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"40px 0 20px","boxShadow":"4px 0px 10px rgba(255, 221, 144, 0.8)","margin":"0","borderRadius":"0 146px 0 0","background":"rgba(255,255,255,0.5)","width":"1100px","height":"90vh"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"100px","fontSize":"28px","fontWeight":"bold"}' class="title">在线小说阅读平台注册</div>
				<el-form-item :style='{"width":"50%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='huiyuan'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">会员账号</div>
					<el-input  v-model="ruleForm.huiyuanzhanghao"  autocomplete="off" placeholder="会员账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"50%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='huiyuan'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">会员姓名</div>
