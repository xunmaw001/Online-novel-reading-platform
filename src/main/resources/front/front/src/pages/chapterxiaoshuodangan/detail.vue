	...
	<div class="detail-preview" :style='{"margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"padding":"0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"minHeight":"500px","width":"41%","padding":"20px 0","margin":"0 7% 0 0","background":"none"}'>
				...
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>章节数</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.chapternum}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>章节标题</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.chaptertitle}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>会员阅读</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.vipread}}</div>
				</div>
