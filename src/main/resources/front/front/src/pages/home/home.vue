...
<div class="home-preview" :style='{"width":"100%","margin":"0 auto","flexWrap":"wrap","justifyContent":"center","display":"flex"}'>
	<el-row type="flex" :gutter="5" justify="center" style="width: 100%">
		...
		<el-col :span="3" v-if="queryIndex==0">
			<el-input v-model="xiaoshuodanganxiaoshuomingcheng" placeholder="小说名称"></el-input>
		</el-col>
		<el-col :span="3" v-if="queryIndex==0">
			<el-button type="primary" @click="search('xiaoshuodangan')">搜索</el-button>
		</el-col>
	</el-row>
...
<div class="recommend" :style='{"margin":"20px auto 0","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230130/d81fd2d44f4e475eb1c571b1f64e5fae.png) no-repeat center top","display":"flex","width":"100%","position":"relative","justifyContent":"center"}'>
    ...
    <div class="title" :style='{"margin":"50px 7% 80px","alignItems":"flex-start","textAlign":"center","background":"none","display":"flex","width":"50%","position":"relative","justifyContent":"center","height":"76px"}'>
		<span :style='{"margin":"0 10px 0 0","fontSize":"32px","color":"#202020","textAlign":"center","fontWeight":"600"}'>小说档案推荐</span>
	</div>
	...
	<div class="list list4 index-pv1" :style='{"width":"100%","padding":"20px 7% 40px","background":"none","height":"auto"}'>
		<div v-if="xiaoshuodanganRecommend.length>0" class="list-item animation-box" @click="toDetail('xiaoshuodanganDetail', xiaoshuodanganRecommend[0])" :style='{"width":"48%","margin":"0","position":"relative","float":"right","height":"570px"}'>
			<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(xiaoshuodanganRecommend[0].fengmian)" :src="xiaoshuodanganRecommend[0].fengmian.split(',')[0]" alt="" />
			<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (xiaoshuodanganRecommend[0].fengmian?xiaoshuodanganRecommend[0].fengmian.split(',')[0]:'')" alt="" />
			<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                <div>小说名称:{{xiaoshuodanganRecommend[0].xiaoshuomingcheng}}</div>
                <div>小说分类:{{xiaoshuodanganRecommend[0].xiaoshuofenlei}}</div>
            </div>
		</div>
		<div class="list-body" :style='{"width":"48%","margin":"0 0 10px","float":"left","justifyContent":"space-between","display":"flex","height":"275px"}'>
			<div v-if="xiaoshuodanganRecommend.length>1" @click="toDetail('xiaoshuodanganDetail', xiaoshuodanganRecommend[1])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(xiaoshuodanganRecommend[1].fengmian)" :src="xiaoshuodanganRecommend[1].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (xiaoshuodanganRecommend[1].fengmian?xiaoshuodanganRecommend[1].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>小说名称:{{xiaoshuodanganRecommend[1].xiaoshuomingcheng}}</div>
                    <div>小说分类:{{xiaoshuodanganRecommend[1].xiaoshuofenlei}}</div>
                </div>
			</div>
			<div v-if="xiaoshuodanganRecommend.length>2" @click="toDetail('xiaoshuodanganDetail', xiaoshuodanganRecommend[2])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(xiaoshuodanganRecommend[2].fengmian)" :src="xiaoshuodanganRecommend[2].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (xiaoshuodanganRecommend[2].fengmian?xiaoshuodanganRecommend[2].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>小说名称:{{xiaoshuodanganRecommend[2].xiaoshuomingcheng}}</div>
                    <div>小说分类:{{xiaoshuodanganRecommend[2].xiaoshuofenlei}}</div>
                </div>
			</div>
		</div>
		<div class="list-body" :style='{"width":"48%","margin":"10px 0 0","float":"left","justifyContent":"space-between","display":"flex","height":"275px"}'>
			<div v-if="xiaoshuodanganRecommend.length>3" @click="toDetail('xiaoshuodanganDetail', xiaoshuodanganRecommend[3])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(xiaoshuodanganRecommend[3].fengmian)" :src="xiaoshuodanganRecommend[3].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (xiaoshuodanganRecommend[3].fengmian?xiaoshuodanganRecommend[3].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>小说名称:{{xiaoshuodanganRecommend[3].xiaoshuomingcheng}}</div>
                    <div>小说分类:{{xiaoshuodanganRecommend[3].xiaoshuofenlei}}</div>
                </div>
			</div>
			<div v-if="xiaoshuodanganRecommend.length>4" @click="toDetail('xiaoshuodanganDetail', xiaoshuodanganRecommend[4])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(xiaoshuodanganRecommend[4].fengmian)" :src="xiaoshuodanganRecommend[4].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (xiaoshuodanganRecommend[4].fengmian?xiaoshuodanganRecommend[4].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>小说名称:{{xiaoshuodanganRecommend[4].xiaoshuomingcheng}}</div>
                    <div>小说分类:{{xiaoshuodanganRecommend[4].xiaoshuofenlei}}</div>
                </div>
			</div>
		</div>
	</div>
...
<div class="news" :style='{"width":"56%","margin":"0 7%","position":"relative","flexWrap":"wrap","background":"none","display":"flex"}'>
	...
	<div class="title" :style='{"margin":"30px auto 20px","alignItems":"center","textAlign":"center","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"flex-start","height":"50px"}'>
		<span :style='{"fontSize":"32px","lineHeight":"60px","color":"#202020","fontWeight":"bold","height":"60px"}'>新闻公告</span>
	</div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryIndex: 0,
        xiaoshuodanganxiaoshuomingcheng: '',
        newsList: [],
        xiaoshuodanganRecommend: [],
    ...
    methods: {
      ...
      search(tablename) {
        if (this.queryIndex == 0 && this.xiaoshuodanganxiaoshuomingcheng) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.xiaoshuodanganxiaoshuomingcheng}});
        }
      },
		getNewsList() {
		...
		getList() {
          ...
          autoSortUrl = "xiaoshuodangan/autoSort";
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					this.xiaoshuodanganRecommend = res.data.data.list;
