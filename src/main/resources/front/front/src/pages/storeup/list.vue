...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"padding":"50px 0 0","margin":"0px 0","color":"#000","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230510/6e792688c5fc46fc8bd7b19893e0186f.png) no-repeat center top","fontSize":"30px","lineHeight":"54px","fontWeight":"bold"}'>我的收藏</div>
