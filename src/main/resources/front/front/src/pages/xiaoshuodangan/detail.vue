		...
		<div class="attr" :style='{"padding":"0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"minHeight":"500px","width":"41%","padding":"20px 0","margin":"0 7% 0 0","background":"none"}'>
				...
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>小说编号</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.xiaoshuobianhao}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>小说分类</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.xiaoshuofenlei}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>章节</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.zhangjie}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>更新时间</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.gengxinshijian}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>作者</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.zuozhe}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>出版社</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.chubanshe}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>小说简介</div>
					<div  :style='{"padding":"8px 10px 0","color":"#666","background":"none","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.xiaoshuojianjie}}</div>
				</div>
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
				...
				<div class="item" :style='{"border":"0 dotted #bfe7e3","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 2px","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#992298","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>小说文件</div>
					<el-button :style='{"padding":"0px 10px","margin":"0px","color":"#333","borderRadius":"20px","textAlign":"center","background":"#fff","width":"auto","lineHeight":"32px","fontSize":"14px","textDecoration":"none","height":"32px"}' @click="download(detail.xiaoshuowenjian)">点击下载</el-button>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#9f9fd7","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('xiaoshuodangan','评分')" @click="onAcross('xiaoshuopingfen','','','')" type="warning">评分</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#08c238","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="freeReadClick" type="success">免费试读</el-button>
				</div>
			</div>
			...
			<div class="hot" :style='{"boxShadow":"0 0px 0px rgb(0 0 0 / 10%)","padding":"150px 7% 40px","margin":"20px 0 0","background":"url(http://codegen.caihongy.cn/20230130/d81fd2d44f4e475eb1c571b1f64e5fae.png) no-repeat center top","width":"100%","position":"relative","height":"auto"}'>
			  ...
			  <div :style='{"padding":"20px","margin":"20px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			    <div v-for="item in hotList" :key="item" :style='{"width":"23%","padding":"0 0 10px","margin":"0 0 10px","borderRadius":"8px","background":"#fff","height":"auto"}' @click="toDetail(item)">
			      <img :style='{"padding":"20px","margin":"0 0 10px","objectFit":"contain","borderRadius":"8px 8px 0 0","background":"url(http://codegen.caihongy.cn/20230131/6afa6fc6db7b4b62bd4e8f4a24f3975e.png) no-repeat center top / 100% 100%","display":"block","width":"100%","height":"280px"}' v-if="item.fengmian && item.fengmian.substr(0,4)=='http'" :src="item.fengmian" alt="">
			      <img :style='{"padding":"20px","margin":"0 0 10px","objectFit":"contain","borderRadius":"8px 8px 0 0","background":"url(http://codegen.caihongy.cn/20230131/6afa6fc6db7b4b62bd4e8f4a24f3975e.png) no-repeat center top / 100% 100%","display":"block","width":"100%","height":"280px"}' v-else :src="baseUrl + (item.fengmian?item.fengmian.split(',')[0]:'')" alt="">
			      <div :style='{"padding":"4px 0","margin":"0 auto 10px","color":"#333","textAlign":"center","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","lineHeight":"30px","fontSize":"14px"}'>{{item.xiaoshuomingcheng}}</div>
			      <div :style='{"padding":"4px 0","margin":"0 auto 10px","color":"#333","textAlign":"center","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","lineHeight":"30px","fontSize":"14px"}'>{{item.xiaoshuofenlei}}</div>
...
<script>
  ...
  export default {
    ...
    methods: {
        init() {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.detail.id, {}).then(res => {
            if (res.data.code == 0) {
              ...
              this.title = this.detail.xiaoshuomingcheng;
        ...
        toDetail(item) {
          this.$router.push({path: '/index/xiaoshuodanganDetail', query: {detailObj: JSON.stringify(item)}});
          this.init();
        ...
        getHotList() {
          let autoSortUrl = "";
          autoSortUrl = "xiaoshuodangan/autoSort";
        ...
        freeReadClick(){
            this.$router.push(('/index/xiaoshuodanganChapter?id=' + this.freeChapterList[0].id))
        },
        chapterClick(vipread,id){
            ...
            this.$router.push(('/index/xiaoshuodanganChapter?id=' + id))
        },
        getFreeChapterList() {
      ...
      onAcross(acrossTable,crossOptAudit,statusColumnName,tips,statusColumnValue){
        localStorage.setItem('crossTable',`xiaoshuodangan`);
      ...
      storeup(type) {
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'xiaoshuodangan', userid: localStorage.getItem('userid')}}).then(res => {
            if (res.data.code == 0 && res.data.data.list.length > 0) {
              this.isStoreup = true;
      ...
      thumbsupOrCrazily(type) {
        ...
        this.$http.post('xiaoshuodangan/update', this.detail).then(res => {});
      },
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'xiaoshuodangan', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'xiaoshuodangan', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
      ...
      getDiscussList(page) {
        this.$http.get('discussxiaoshuodangan/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussxiaoshuodangan/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
